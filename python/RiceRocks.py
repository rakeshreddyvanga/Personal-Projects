...
def draw(canvas):
    ...
    # draw UI
    canvas.draw_text("Lives", [50, 50], 22, "Yellow", "monospace")
    canvas.draw_text("Score", [680, 50], 22, "Yellow", "monospace")
    canvas.draw_text(str(lives), [50, 80], 20, "Yellow", "monospace")
    canvas.draw_text(str(score), [680, 80], 20, "Yellow", "monospace")
...
# process the set of sprite objects to draw and update
...
# process the set of sprite objects for collision detection
...
rock_group.add(Sprite([WIDTH / 3, HEIGHT / 3], [6, -8], 0, .1, asteroid_image, asteroid_info))
