...
public class Evaluation1Client {
	String fromServer = "";
	...
	public static void main(String[] args) {
		Evaluation1Client connection = new Evaluation1Client();
			...
			while (true) { // while loop to play till the end of the game
				...
				while (true) { // while loop for taking the complete take turn element		
					...
					/*if (buildAction.contains("End")) {
						System.out.println("Eval1 Ended");
						serverSocket.close();
	...
	public String TakeTurn(String fromServer) {
		...
		try {
			...
			actionStr = SelectPlayer.takeTurn2(fromServer, "eval1");
		...
		//System.out.println("eval"+actionStr);
		return actionStr;
	}
}
