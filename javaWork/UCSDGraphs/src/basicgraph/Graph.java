...
public abstract class Graph {
	...
	public List<Integer> degreeSequence() {
		...
		for(int v=0;v<numVertices;v++){
			seq.add(getInNeighbors(v).size() + getNeighbors(v).size()); 
		}
		Collections.sort(seq,Comparator.reverseOrder());
		return seq;
	}
	...
	public static void main (String[] args) {
		...
		List<Integer> degSeq = graphFromFile.degreeSequence();
		System.out.println("Degree Sequence:");
		for(Integer seq: degSeq){
			System.out.print(seq.intValue()+" ");
		}
		System.out.println();
